...
export const getMessagesApi = (tripId) => request(`/api/trips/${tripId}/messages`);
export const sendMessageApi = (tripId, payload) => request(`/api/trips/${tripId}/messages`, { method: "POST", body: payload });
