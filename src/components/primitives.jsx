...
export function Avatar({ member, size = 32 }) {
  ...
  return (
    <div style={{
      ...
      fontFamily: "'Libre Baskerville',sans-serif", fontWeight: 700, color: "#2A1C10",
...
export function SectionLabel({ children, icon: Icon }) {
  return (
    <div style={{ display: "flex", alignItems: "center", gap: 6, color: T.muted, fontSize: 11, letterSpacing: 1, textTransform: "uppercase", fontFamily: "'Libre Baskerville',sans-serif", margin: "18px 0 10px" }}>
...
export function Spinner({ label = "Yükleniyor..." }) {
  return (
    <div style={{ display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", gap: 12, padding: "60px 20px", color: T.muted }}>
      ...
      <span style={{ fontSize: 12.5, fontFamily: "'Libre Baskerville',sans-serif" }}>{label}</span>
    </div>
  );
}
...
export function Empty({ text }) {
  return <div style={{ color: T.muted, fontSize: 13, textAlign: "center", padding: "24px 10px", fontFamily: "'Libre Baskerville',sans-serif" }}>{text}</div>;
}
  ...
  return (
    <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: 8 }}>
      ...
      <button onClick={onRefresh} style={{
        ...
        gap: 4, fontSize: 10.5, cursor: "pointer", fontFamily: "'Libre Baskerville',sans-serif",
      }}>
    ...
    <div style={{ marginBottom: 10 }}>
      ...
      <input value={value} onChange={e => onChange(e.target.value)} placeholder={placeholder} type={type}
        style={{
          ...
          padding: "10px 12px", color: T.text, fontSize: 16, fontFamily: "'Libre Baskerville',sans-serif", boxSizing: "border-box",
        }} />
    </div>
  );
}
