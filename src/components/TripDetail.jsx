    ...
    <div>
      ...
      <div style={{
        ...
        <div style={{ flex: 1, minWidth: 0 }}>
          <div style={{ fontFamily: "'Libre Baskerville',sans-serif", fontWeight: 600, fontSize: 18, color: "#FFF9F0", whiteSpace: "nowrap", overflow: "hidden", textOverflow: "ellipsis" }}>{trip.name}</div>
      ...
      <div style={{ padding: "14px 16px 100px" }}>
        {view === "home" && <HomeTab trip={trip} fx={fx} weather={weather} myMemberId={myMember?.id} setView={setView} />}
